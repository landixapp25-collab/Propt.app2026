...
export default function LandingPage({ onNavigateToSignup, onNavigateToLogin }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#365563' }}>
      {/* Navigation Header */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-gray-700" style={{ backgroundColor: '#365563', opacity: 0.95, backdropFilter: 'blur(8px)' }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative rounded-2xl p-8 shadow-2xl border border-gray-600" style={{ backgroundColor: '#537d90' }}>
                <div className="rounded-xl p-6 mb-4" style={{ backgroundColor: '#4a6d7e' }}>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="rounded-lg p-3" style={{ backgroundColor: '#365563' }}>
                ...
                <div className="rounded-xl p-4" style={{ backgroundColor: '#4a6d7e' }}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#2a4a56' }}>
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-white text-center mb-12">
            Built for Solo Developers
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-xl p-8 border border-gray-600 hover:border-[#5a9aa8] transition-all" style={{ backgroundColor: '#365563' }}>
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="rounded-xl p-6 border border-gray-600 hover:border-[#FF6B6B] transition-all" style={{ backgroundColor: '#537d90' }}>
            ...
            <div className="rounded-xl p-6 border border-gray-600 hover:border-[#5a9aa8] transition-all" style={{ backgroundColor: '#537d90' }}>
            ...
            <div className="rounded-xl p-6 border border-gray-600 hover:border-[#4ECDC4] transition-all" style={{ backgroundColor: '#537d90' }}>
            ...
            <div className="rounded-xl p-6 border border-gray-600 hover:border-[#FFB84D] transition-all" style={{ backgroundColor: '#537d90' }}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#2a4a56' }}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="rounded-xl border border-gray-600 overflow-hidden" style={{ backgroundColor: '#365563' }}>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-600" style={{ backgroundColor: '#2a4a56' }}>
                    <th className="text-left py-4 px-6 text-gray-200 font-semibold">Feature</th>
                    <th className="text-center py-4 px-6 text-gray-200 font-semibold">Competitors</th>
                ...
                <tbody>
                  <tr className="border-b border-gray-600">
                    ...
                    <td className="text-center py-4 px-6">
                      <div className="text-gray-300 text-sm">Built for developers</div>
                    </td>
                  </tr>
                  <tr className="border-b border-gray-600">
                    <td className="py-4 px-6 text-white">AI receipt extraction</td>
                    <td className="text-center py-4 px-6 text-gray-300 text-sm">£10/mo extra</td>
                    <td className="text-center py-4 px-6">
                  ...
                  <tr className="border-b border-gray-600">
                    ...
                    <td className="text-center py-4 px-6">
                      <X size={24} className="text-gray-500 mx-auto" />
                    </td>
                    <td className="text-center py-4 px-6">
                      <Check size={24} className="text-[#4ECDC4] mx-auto" />
                    </td>
                  ...
                  <tr className="border-b border-gray-600">
                    ...
                    <td className="text-center py-4 px-6 text-gray-300 text-sm">Desktop-focused</td>
                    <td className="text-center py-4 px-6">
                      <Check size={24} className="text-[#4ECDC4] mx-auto" />
                    </td>
                  </tr>
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Free Plan */}
            <div className="rounded-xl p-8 border border-gray-600" style={{ backgroundColor: '#537d90' }}>
            ...
            {/* Business Plan */}
            <div className="rounded-xl p-8 border border-gray-600 relative" style={{ backgroundColor: '#537d90' }}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#2a4a56' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-sm mt-4">No credit card required</p>
        </div>
      </section>
