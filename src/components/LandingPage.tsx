        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-2">
              <Logo size={32} />
              <span className="text-xl font-bold text-gray-900">Propt</span>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  onClick={onNavigateToSignup}
                  className="flex items-center justify-center gap-2 px-8 py-4 bg-white text-gray-900 rounded-lg font-semibold border-2 border-gray-300 hover:border-[#537d90] transition-all"
                >
                  View Demo
                </button>
              </div>
            ...
            <div className="relative">
              <div className="relative bg-white rounded-2xl p-8 shadow-2xl border border-gray-200">
                <div className="bg-gray-50 rounded-xl p-6 mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white rounded-lg p-3 border border-gray-200">
                      ...
                      <div className="text-xs text-gray-600">Profit (YTD)</div>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-gray-200">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  <div className="text-sm text-gray-600 mb-2">Recent Transaction</div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#FF6B6B] bg-opacity-10 rounded-full flex items-center justify-center">
                        <Camera size={18} className="text-[#FF6B6B]" />
                      </div>
                      <div>
                        <div className="text-gray-900 font-semibold">Buildbase Materials</div>
                        <div className="text-xs text-gray-500">Construction Materials</div>
                      </div>
                    </div>
                    <div className="text-gray-900 font-bold">£3,245</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 border border-gray-200 hover:border-[#537d90] transition-all shadow-sm hover:shadow-md">
              <div className="w-14 h-14 bg-[#FF6B6B] bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                <TrendingUp size={28} className="text-[#FF6B6B]" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">1-10 Deals Per Year</h3>
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200 hover:border-[#537d90] transition-all shadow-sm hover:shadow-md">
              <div className="w-14 h-14 bg-[#5a9aa8] bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                <FileText size={28} className="text-[#5a9aa8]" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Currently Using Spreadsheets</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200 hover:border-[#537d90] transition-all shadow-sm hover:shadow-md">
              <div className="w-14 h-14 bg-[#4ECDC4] bg-opacity-10 rounded-full flex items-center justify-center mb-4">
                <Users size={28} className="text-[#4ECDC4]" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">DIY Finance</h3>
              <p className="text-gray-600">
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#FF6B6B] transition-all shadow-sm hover:shadow-md">
              <div className="w-12 h-12 bg-[#FF6B6B] bg-opacity-10 rounded-lg flex items-center justify-center mb-4">
                <Camera size={24} className="text-[#FF6B6B]" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">AI Receipt Extraction</h3>
              <p className="text-gray-600 text-sm">
                Snap a photo, we extract vendor, amount, date automatically
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#5a9aa8] transition-all shadow-sm hover:shadow-md">
              <div className="w-12 h-12 bg-[#5a9aa8] bg-opacity-10 rounded-lg flex items-center justify-center mb-4">
                <Calculator size={24} className="text-[#5a9aa8]" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">BRRR Deal Analyzer</h3>
              <p className="text-gray-600 text-sm">
                Analyze deals with real market research before you buy
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#4ECDC4] transition-all shadow-sm hover:shadow-md">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-2">Tax Pack Exports</h3>
              <p className="text-gray-600 text-sm">
                One-click export of all transactions and receipts for your accountant
              </p>
            </div>

            <div className="bg-white rounded-xl p-6 border border-gray-200 hover:border-[#FFB84D] transition-all shadow-sm hover:shadow-md">
              <div className="w-12 h-12 bg-[#FFB84D] bg-opacity-10 rounded-lg flex items-center justify-center mb-4">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 bg-gray-50">
                    ...
                    <th className="text-center py-4 px-6 text-gray-700 font-semibold">Competitors</th>
                    <th className="text-center py-4 px-6 text-[#FF6B6B] font-semibold">Propt</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-200">
                    <td className="py-4 px-6 text-gray-900">Built for landlords</td>
                    <td className="text-center py-4 px-6">
                      <Check size={24} className="text-green-500 mx-auto" />
                    </td>
                    <td className="text-center py-4 px-6">
                      <div className="text-gray-600 text-sm">Built for developers</div>
                    </td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <td className="py-4 px-6 text-gray-900">AI receipt extraction</td>
                    <td className="text-center py-4 px-6 text-gray-600 text-sm">£10/mo extra</td>
                    <td className="text-center py-4 px-6">
                      <Check size={24} className="text-[#4ECDC4] mx-auto" />
                    </td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <td className="py-4 px-6 text-gray-900">BRRR deal analysis</td>
                    <td className="text-center py-4 px-6">
                      <X size={24} className="text-gray-400 mx-auto" />
                    </td>
                    <td className="text-center py-4 px-6">
                      <Check size={24} className="text-[#4ECDC4] mx-auto" />
                    </td>
                  ...
                  <tr className="border-b border-gray-200">
                    <td className="py-4 px-6 text-gray-900">Mobile-first design</td>
                    <td className="text-center py-4 px-6 text-gray-600 text-sm">Desktop-focused</td>
                    <td className="text-center py-4 px-6">
                      <Check size={24} className="text-[#4ECDC4] mx-auto" />
                    </td>
                  </tr>
                  <tr>
                    <td className="py-4 px-6 text-gray-900">Developer categories</td>
                    <td className="text-center py-4 px-6">
                      <X size={24} className="text-gray-400 mx-auto" />
                    </td>
                    <td className="text-center py-4 px-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm">
              ...
              <div className="text-4xl font-bold text-gray-900 mb-6">£0<span className="text-base text-gray-600">/month</span></div>
            ...
            <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm relative">
              <div className="absolute top-4 right-4 bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-xs font-bold">
                Coming Soon
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Business</h3>
              <div className="text-4xl font-bold text-gray-900 mb-6">£49<span className="text-base text-gray-600">/month</span></div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3 text-gray-700">
                  <Check size={20} className="text-[#4ECDC4] mt-0.5 flex-shrink-0" />
